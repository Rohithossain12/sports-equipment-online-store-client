      ...
      <div className="grid  grid-cols-2 md:grid-cols-3 lg:grid-cols-4 relative ">
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-12" place="top" content="Badminton" />
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-11" place="top" content="Baseball" />
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-10" place="top" content="Basketball" />
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-9" place="top" content="Cricket" />
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-8" place="top" content="Football" />
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-6" place="top" content="Table Tennis" />
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-5" place="top" content="Rugby" />
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-4" place="top" content="Netball" />
        ...
        <div className="text-center transition hover:scale-105">
          <img
            ...
            alt=""
          />
          <ReactTooltip id="my-tooltip-3" place="top" content="Water Polo" />
