  ...
  return (
    <div className="bg-base-300 p-6 ">
      <footer className="footer bg-base-300 text-base-content ">
        <nav>
          <img
            className="h-10 w-24 md:w-44 md:h-16"
        ...
        <nav>
          ...
          <a className="link link-hover">Product Customization</a>
          <a className="link link-hover"> Equipment Recommendations</a>
          <a className="link link-hover"> Team Discounts</a>
          <a className="link link-hover">Quick Delivery Service</a>
          <a className="link link-hover">Sports Event Sponsorship</a>
        </nav>
        <nav>
