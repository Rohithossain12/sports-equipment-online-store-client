    ...
    <div className="mt-8 mb-10">
      ...
      <Fade delay={1e3} cascade damping={1e-1}>
        <p>
          ...
          driveway, Escalade Sports offers multiple brands of basketball hoops
          and accessories to explore. Choose between four different type of
          basketball goals — in-ground, portable, wall-mounted, and youth hoops
          in order to provide fun for years to come.{" "}
        </p>
      </Fade>
      <Slide>
      ...
      <Fade delay={1e3} cascade damping={1e-1}>
        <p>
          ...
          room the competitive edge you need with our wide selection of
          billiards supplies, including pool table equipment, cues, and
          billiards gear.{" "}
        </p>
      </Fade>
      <Slide>
      ...
      <Fade delay={1e3} cascade damping={1e-1}>
        <p>
          Besides the basics, our extensive collection of darts and dart
          supplies covers a wide range of products from dart sets to dartboards,
          cabinets, and backboards, as well as every accessory you could
          imagine. Whether you are someone wanting to add an extra piece of fun
          to the game room, or someone who needs to upgrade their darts before a
          competitive tournament, we offer a wide selection of options to ensure
          you have everything you need that involves darting.
        </p>
      </Fade>
      <Slide>
      ...
      <Fade delay={1e3} cascade damping={1e-1}>
        <p>
          ...
          in order to take your game to the next level. Whether it's just for
          fun or for competitive practice before a big tournament, make sure you
          are prepared with exactly the things you need!{" "}
        </p>
      </Fade>
      <Slide>
      ...
      <Fade delay={1e3} cascade damping={1e-1}>
        <p>
          ...
          bows, arrows, and targets for all levels, from beginners in the sport
          to sharpshooters. There is something for every type of shot.{" "}
        </p>
      </Fade>
      <Slide>
      ...
      <Fade delay={1e3} cascade damping={1e-1}>
        <p>
          ...
          covered. Training tools from Goalrilla replicate the in-game
          experience so you are ready to perform when the time comes.
        </p>
      </Fade>
      <Slide>
      ...
      <Fade delay={1e3} cascade damping={1e-1}>
        <p>
          With our wide selection of Fitness & Training Equipment, you can be
          sure to amp up your current workout routine, start new healthy habits,
          and fill your home gym in order to be your best self.
        </p>
      </Fade>
    </div>
  );
