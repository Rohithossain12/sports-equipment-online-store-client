  ...
  return (
    <div className="mt-8 mb-10">
      ...
      <p>
        ...
        including products from basketball, pickleball, billiards, darts, table
        tennis, soccer, baseball, and football training, as well as archery and
        fitness. Explore the wide variety of equipment offered across the board
